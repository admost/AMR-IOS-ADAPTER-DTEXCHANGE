![AMRAdapterDTExchange: Admost Mediation iOS SDK](https://www.admost.com/img/logo.svg)
...
[![CocoaPods Compatible](https://img.shields.io/cocoapods/v/AMRAdapterDTExchange.svg?style=flat-square)](https://img.shields.io/cocoapods/v/AMRAdapterDTExchange.svg)
...
# AMRAdapterDTExchange

DT Exchange adapter for AMRSDK. Allows publishers to mediate DT Exchange banner, interstitial and video ads in AMRSDK.
...
```
https://github.com/admost/AMR-IOS-ADAPTER-DTEXCHANGE.git
```
